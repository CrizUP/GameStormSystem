 ...
 * USAGE:
 * <pre>
 *        ServicioJuego client = new ServicioJuego();
...
public class ServicioJuego {
    ...
    public ServicioJuego() {
        ...
        webTarget = client.target(BASE_URI).path("modelo.juego");
    }
    ...
    public Response subirImagen(String id) throws ClientErrorException {
    ...
    public void subirImagenJSF(String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("fotos/{0}", new Object[]{id})).request().post(null);
    }
